...
#[ORM\Entity(repositoryClass: Besteak3Repository::class)]
class Besteak3 implements \Stringable
{
    /**
     * @var integer
     */
     ...
     * @var ArrayCollection
     */
    #[ORM\ManyToMany(targetEntity: Fitxa::class, mappedBy: 'besteak3ak', cascade: ['persist'])]
    private $fitxak;
