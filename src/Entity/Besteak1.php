...
#[ORM\Table(name: 'besteak1')]
#[ORM\Entity(repositoryClass: Besteak1Repository::class)]
class Besteak1 implements \Stringable
{
    /**
     * @var integer
     */
     ...
     * @var ArrayCollection
     */
    #[ORM\ManyToMany(targetEntity: Fitxa::class, mappedBy: 'besteak1ak', cascade: ['persist'])]
    private $fitxak;
