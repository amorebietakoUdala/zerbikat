...
class AzpiatalaparrafoaRepository extends ServiceEntityRepository
{
    ...
    // /**
    //  * @return Azpiatalaparrafoa[] Returns an array of Azpiatalaparrafoak objects
    //  */

    // public function findByAzpiatalaparrafoakByUdala($udala)
    // {
    ...
    /*
    public function findOneBySomeField($value): ?Azpiatalaparrafoak
    {
        return $this->createQueryBuilder('s')
