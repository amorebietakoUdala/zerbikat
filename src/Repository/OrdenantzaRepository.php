...
class OrdenantzaRepository extends ServiceEntityRepository
{
    ...
    // /**
    //  * @return Ordenantza[] Returns an array of Ordenantzak objects
    //  */

    // public function findByOrdenantzakByUdala($udala)
    // {
    ...
    /*
    public function findOneBySomeField($value): ?Ordenantzak
    {
        return $this->createQueryBuilder('s')
