...
class OrdenantzaparrafoaRepository extends ServiceEntityRepository
{
    ...
    // /**
    //  * @return Ordenantzaparrafoa[] Returns an array of Ordenantzaparrafoak objects
    //  */

    // public function findByOrdenantzaparrafoakByUdala($udala)
    // {
    ...
    /*
    public function findOneBySomeField($value): ?Ordenantzaparrafoak
    {
        return $this->createQueryBuilder('s')
